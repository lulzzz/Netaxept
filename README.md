...
![Payment method settings](/docs/screenshots/overview.PNG?raw=true "Payment method settings")

The merchant id and token are necessary for establishing a connection to the service of Netaxept.

![Payment method settings](/docs/screenshots/parameters.PNG?raw=true "Payment method parameters")
...
![Order notes](/docs/screenshots/notes.PNG?raw=true "Order notes")
